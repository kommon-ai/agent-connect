...
type RemoteAgentServiceClient interface {
	ExecuteTask(context.Context, *connect_go.Request[proto.ExecuteTaskRequest]) (*connect_go.Response[proto.ExecuteTaskResponse], error)
	Ping(context.Context, *connect_go.Request[proto.PingRequest]) (*connect_go.Response[proto.PingResponse], error)
}
...
func NewRemoteAgentServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) RemoteAgentServiceClient {
	...
	return &remoteAgentServiceClient{
		executeTask: connect_go.NewClient[proto.ExecuteTaskRequest, proto.ExecuteTaskResponse](
			httpClient,
			baseURL+RemoteAgentServiceExecuteTaskProcedure,
			opts...,
		),
		ping: connect_go.NewClient[proto.PingRequest, proto.PingResponse](
			httpClient,
...
type remoteAgentServiceClient struct {
	executeTask *connect_go.Client[proto.ExecuteTaskRequest, proto.ExecuteTaskResponse]
	ping        *connect_go.Client[proto.PingRequest, proto.PingResponse]
}

// ExecuteTask calls remote.RemoteAgentService.ExecuteTask.
func (c *remoteAgentServiceClient) ExecuteTask(ctx context.Context, req *connect_go.Request[proto.ExecuteTaskRequest]) (*connect_go.Response[proto.ExecuteTaskResponse], error) {
	return c.executeTask.CallUnary(ctx, req)
}

// Ping calls remote.RemoteAgentService.Ping.
func (c *remoteAgentServiceClient) Ping(ctx context.Context, req *connect_go.Request[proto.PingRequest]) (*connect_go.Response[proto.PingResponse], error) {
...
func (UnimplementedRemoteAgentServiceHandler) ExecuteTask(context.Context, *connect_go.Request[proto.ExecuteTaskRequest]) (*connect_go.Response[proto.ExecuteTaskResponse], error) {
...
func (UnimplementedRemoteAgentServiceHandler) Ping(context.Context, *connect_go.Request[proto.PingRequest]) (*connect_go.Response[proto.PingResponse], error) {
